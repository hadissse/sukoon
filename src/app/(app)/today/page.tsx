      ...
      <div className="px-5 flex flex-col gap-4 pt-5">
        ...
        <Link href="/log" className="block">
          <div className="relative rounded-[20px] overflow-hidden p-5" style={{ background: 'linear-gradient(135deg, #F8D6BE 0%, #F0C0A0 100%)' }}>
            <img src="/media/sun-rings.gif" alt="" loading="lazy" aria-hidden="true" className="absolute -bottom-4 -left-4 w-[120px] h-[110px] object-cover pointer-events-none opacity-55" style={{ mixBlendMode: 'multiply' }} />
            <div className="relative">
        ...
        <Link href="/self" className="block">
          <div className="relative rounded-[20px] overflow-hidden p-5" style={{ background: 'linear-gradient(135deg, #C2D3E2 0%, #A8C0D6 100%)' }}>
            <img src="/media/moon-water.gif" alt="" loading="lazy" aria-hidden="true" className="absolute -top-4 -left-4 w-[120px] h-[120px] object-cover pointer-events-none opacity-50 rounded-xl" />
            <div className="relative">
        ...
        <Link href="/learn" className="block">
          <div className="relative rounded-[20px] overflow-hidden p-5" style={{ background: 'linear-gradient(135deg, #F0C8A0 0%, #E0B080 100%)' }}>
            <img src="/media/match-flame.gif" alt="" loading="lazy" aria-hidden="true" className="absolute -bottom-4 -left-4 w-[110px] h-[110px] object-cover pointer-events-none opacity-65 rounded-xl" style={{ mixBlendMode: 'multiply' }} />
            <div className="relative">
        ...
        <Link href="/evening" className="block">
          <div className="relative rounded-[20px] overflow-hidden p-5" style={{ background: '#0F1228' }}>
            <img src="/media/moon-flames.gif" alt="" loading="lazy" aria-hidden="true" className="absolute top-0 left-0 h-full w-[110px] object-cover pointer-events-none opacity-60" style={{ mixBlendMode: 'screen' }} />
