...
export const CAL_TRANSITS: Record<number, CalEvent[]> = {
  2: [{ svgKey: 'moon', title: 'القمر يدخل السرطان', kind: 'ingress', color: '#7E97B8', time: '٠٤:٢٠', body: 'القمر يدخل السرطان، برجٌ مائي حسّاس.' }],
  6: [
  ...
  14: [{ svgKey: 'mercury', title: 'عطارد ساكن', kind: 'station', color: '#D4A04C', time: '٠٣:١٠', body: 'عطارد ساكن عند الدرجة الثامنة من الجوزاء قبل الرجوع.' }],
  17: [{ svgKey: 'mars', title: 'المريخ □ زحل', kind: 'aspect', color: '#9A3F30', time: '٠٩:٢٤', body: 'تربيع المريخ وزحل، ضمن درجتين.' }],
  ...
  28: [{ svgKey: 'mars', title: 'المريخ يدخل الأسد', kind: 'ingress', color: '#D4A04C', time: '٢٠:١٨', body: 'المريخ يدخل الأسد، حاكم البرج.' }],
