...
export const ESSAYS: Record<string, TransitEssay> = {
  'saturn-return': {
    ...
    words: '٧٥٠',
    blocks: [
      { callout: 'نشطة لك الآن · تنتهي في فبراير ٢٠٢٧' },
  ...
  'neptune-sun': {
    ...
    blocks: [
      ...
      {
        para: [
          'الخطر الثاني: الانخداع. حين تذوب الحدود، يَسهل أن تخلط بين الإشارات. شخصٌ يبدو ملاكًا قد يكون عاديًّا. مشروعٌ يبدو مَوهبةً قد يكون هَوسًا. لا تتّخذ قراراتٍ كبرى في عمق هذا العبور — انتظر حتى يستقرّ نبتون.',
        ],
      },
      {
        para: [
