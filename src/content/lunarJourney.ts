...
export const LUNAR_PHASES: LunarPhase[] = [
  ...
  },
  {
    ...
    practice: 'خمس دقائق لنيّتك تكفي. الاستمراريّة أهمّ من الكثافة.',
    duration: '~٤ أيّام',
    accent: '#5A3E7A',
  },
  {
  ...
  },
  {
    ...
    practice: 'اشكر شخصًا بكلامٍ صادق، لا بمجاملةٍ تلقائيّة.',
    duration: '~٤ أيّام',
    accent: '#D4A04C',
  },
  {
  ...
  },
  {
    ...
    practice: 'خذ ساعةً بلا شاشات. مجرّد جلوس مع نَفَسك.',
    duration: '~٤ أيّام',
    accent: '#5C5C7A',
  },
];
